    ...
    <main className="w-full h-screen bg-gray-50 flex  ">
      ...
      <div className="px-1 py-2 w-50 h-full space-y-7 ">
        <div className="px-1">
          <Link
            to="/"
            className="rounded-full bg-neutral-800 flex justify-center items-center w-fit px-3 py-2 text-xl capitalize font-poppin cursor-pointer "
          >
        ...
        <ul className="w-full flex flex-col gap-1 bg-gray">
          <li
            ...
            className="hover:bg-white/80 py-2 px-1 rounded-md cursor-pointer flex gap-1 items-center"
          >
            <i className="ri-profile-line text-xl"></i>{" "}
            <span className="md:block hidden">Create product</span>{" "}
          </li>
          <li
