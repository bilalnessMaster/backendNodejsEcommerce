...
const User = ({firstName , email , _id , role , createdAt}) => {
  return (
    <tr className='border-t  '>
        <td className=' py-3 px-3 flex items-center gap-2 font-medium w-fit'> 
        ...
        <td className='px-3'>
            <select  className='border-2 rounded-md px-2 py-1 text-center capitalize' name="role" value={role}  id="">
        ...
        <button className='text-red-600 border-b-2 border-red-600'>
            Delete
        </button>
